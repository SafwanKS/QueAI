  ...
  return (
    <div ref={ref} className="right-sidebar">
        <div className="right-sidebar-header">
            <div className="right-sidebar-header-left">
                <span className="material-symbols-outlined">manage_search</span>
                <h3>Related</h3>
            </div>
            <div className="right-sidebar-header-right">
                <div className="sidebar-collapse-btn" onClick={()=> setRightSideBarCollapsed(prev => !prev)}>
                    <span className="material-symbols-outlined">{rightSideBarCollapsed ? "right_panel_open" : "right_panel_close"}</span>
                </div>
            </div>
        </div>
