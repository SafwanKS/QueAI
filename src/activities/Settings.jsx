            ...
            <div ref={settingsWrapper} className="settings-wrapper">
                ...
                <div className="settings-body">
                    ...
                    <div className={`settingsContentContainer ${showSettingsContent ? "showContent" : "hideContent"}`}>
                        ...
                        }
                        {
                            ...
                            <div className='animations'>
                                ...
                                </div>
                                {
                                    darkmode &&
                                    <div className="settings-item">
                                        <p className="item-name">Use pure black</p>
                                        <div className={`switch ${useBlack && "active"}`} onClick={() => {
                                            setUseBlack(!useBlack)
                                            localStorage.setItem("useBlack", JSON.stringify(!useBlack))
                                        }}>
                                            <div className="switch-btn"></div>
                                        </div>
                                    </div>
                        ...
                        {
                            selectedSettingsItem == "personalization" &&
